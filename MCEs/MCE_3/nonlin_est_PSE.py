...
for _ in range(iterations):
    ...
    # Logistic transformation to ensure binary outcome
    logit_Y = -0.5 + 0.3 * A + 0.1 * C + 0.3 * M_x + 0.3 * A * M_x + 0.3 * L_x
