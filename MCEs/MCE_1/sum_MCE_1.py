...
base_path = '/Users/changhuizhou/Desktop/Midway_MCE_results/LINEAR'
folder = '2k'
path = os.path.join(base_path, folder, '')

# List of file names to be appended
file_names = [f'2k_final_results_{i}.csv' for i in range(1, 16)]
...
final_results_file_path = os.path.join(path, '2k_final_results.csv')
...
summary_stats_df.to_csv(path + '2k_summary_statistics.csv', index=True)

diff = {
    'Diff_ATE (A->Y)': summary_stats_df.loc['cGNF_ATE (A->Y)'] - summary_stats_df.loc['reg_ATE (A->Y)'],
    'Diff_PSE (A->Y)': summary_stats_df.loc['cGNF_PSE (A->Y)'] - summary_stats_df.loc['reg_PSE (A->Y)'],
    'Diff_PSE (A->L->Y)': summary_stats_df.loc['cGNF_PSE (A->L->Y)'] - summary_stats_df.loc['reg_PSE (A->L->Y)'],
    'Diff_PSE (A->M->Y)': summary_stats_df.loc['cGNF_PSE (A->M->Y)'] - summary_stats_df.loc['reg_PSE (A->M->Y)'],
    'Diff_ATE (A->M)': summary_stats_df.loc['cGNF_ATE (A->M)'] - summary_stats_df.loc['reg_ATE (A->M)'],
    'Diff_NDE': summary_stats_df.loc['cGNF_NDE'] - summary_stats_df.loc['reg_NDE'],
    'Diff_NIE': summary_stats_df.loc['cGNF_NIE'] - summary_stats_df.loc['reg_NIE']
}
