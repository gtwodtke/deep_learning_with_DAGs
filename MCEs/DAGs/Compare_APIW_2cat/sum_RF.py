...
base_path = '/Users/jessezhou/Desktop/Revision/RFs'
folder = '128k'
path = os.path.join(base_path, folder, '')

# # List of file names to be appended
# file_names = [f'128k_final_results_{i}.csv' for i in range(1, 6)]
#
...
final_results_df['cGNF_ATE (A->Y) with bootstrap'] = final_results_df['E_Y_1_boot'] - final_results_df['E_Y_0_boot']
...
true_values = {
    'cGNF_ATE (A->Y)': 0.3,
    'cGNF_ATE (A->Y) with bootstrap': 0.3,
    'ATEhat': 0.3,
}
